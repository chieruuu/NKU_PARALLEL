...
// GPU版本编译指令示例：
// hipcc main_GPU.cpp train.cpp guessing_GPU.hip md5.cpp -o main_GPU
// hipcc main_GPU.cpp train.cpp guessing_GPU.hip md5.cpp -o main_GPU -O1
// hipcc main_GPU.cpp train.cpp guessing_GPU.hip md5.cpp -o main_GPU -O2
